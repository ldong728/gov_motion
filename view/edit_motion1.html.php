...
<div class="sug-main">
    <div class="sug-main-nav clearfix">
        ...
        <?php if(current($motion)['step']>4&&2==$meetingInf['category']):?><a href="?download=reply_table2&motion_id=<?php echo current($motion)['motion_id']?>&category=<?php echo current($motion)['category']?>&meeting_name=<?php echo $meetingInf['meeting_name']?>">下载反馈表</a><?php endif?>
