...
<nav class="home-nav">
    <ul class="clearfix">
        ...
        <?php if(2==$meetingInf['category']):?><li><a href="#" class="search" data-filter="性质" data-type="string">按性质</a></li><?php endif ?>
        <!--                        <td width="15%"><a href="#" class="search" >按等级时间（序列）</a></li>-->
        <li><a href="#" class="search" data-filter="性质类别<?php echo $meetingInf['category']?>" data-type="string">按性质类别</a></li>
        <li><a href="#" class="search" data-filter="状态" data-type="string">按状态</a></li>
        <li><a href="#" class="search" data-filter="<?php echo 1==$meetingInf['category']?'领衔人':'提案人'?>" data-type="duty">按<?php echo 1==$meetingInf['category']?'领衔人':'提案人'?></a></li>
...
<section class="clearfix" id="section">
    <aside id="aside">
        <ul>
            <li><p><a href="#" class="list-filter" data-step="5" ><i class="icon icon-angle-right"></i>全部<span></span></a></p></li>
            <?php if(in_array(5,$_SESSION['staffLogin']['steps'])&&1==count($_SESSION['staffLogin']['steps'])):?>
                <li><p><a href="#" class="list-filter" data-step="5" data-filtertype="mainhandle"><i class="icon icon-angle-right"></i>主办列表<span></span></a></p></li>
                <li><p><a href="#" class="list-filter" data-step="5" data-filtertype="handle"><i class="icon icon-angle-right"></i>协办列表<span></span></a></p></li>
                <li><p><a href="#" class="list-filter" data-step="5" data-filtertype="can-mainhandle"><i class="icon icon-angle-right"></i>主办可办<span></span></a></p></li>
                <li><p><a href="#" class="list-filter" data-step="5" data-filtertype="can-handle"><i class="icon icon-angle-right"></i>协办可办<span></span></a></p></li>
            <?php endif?>
            <?php if(in_array(3,$_SESSION['staffLogin']['steps'])):?>
                <li><p><a href="#"  data-step="3" data-filtertype="mainhandle"><i class="icon icon-angle-right"></i><?php echo 1==$_SESSION['staffLogin']['category']?'代表名单管理':'委员名单管理'?><span></span></a></p></li>
                <?php if(2==$_SESSION['staffLogin']['category']):?><li><p><a href="#" class="multiple-statistics" data-step="3" data-filtertype="mainhandle"><i class="icon icon-angle-right"></i><span>综合统计</span></a></p></li><?php endif ?>
            <?php endif ?>
            <?php if(in_array(4,$_SESSION['staffLogin']['steps'])):?>
                <li><p><a href="index.php?statistics_excel_out=1" class="statistics"><i class="icon icon-angle-right"></i>办理统计<span></span></a></p></li>
            <?php endif ?>
