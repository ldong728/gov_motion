...
<div class="m-home clearfix">
    <div class="home-l">          <!--左边-->
        <div class="home-nav h-border"><p class="icon icon-angle-right">人大议案建议</p></div>
        ...
        <div class="magin">
            ...
            <div class="home-seat">
                <div class="content-seat">
                    <h2>当前位置：</h2>
                    <a href="#" class="icon">建议提案</a>
                    <a href="#" class="icon icon-angle-right">人大建议议案</a>
                    <a href="#" class="icon icon-angle-right">按案号</a>
                </div>
                <div class="content-b">
                ...
                <div class="home-table">
                    <table width="100%" border="1" cellspacing="0" cellpadding="0" class="list-table">
                        ...
                        <tr>
                            ...
                            <th width="8%" class="order-by-attr">案别</th>
...
//            console.log(back);
            ...
            $.each(value.sort,function(k,v){
                var listContent='<tr class="list-content">'+
                    ...
                    '<td>'+ c[v]['领衔人']+'</td>'+
                    '<td>'+ c[v]['案别']+'</td>'+
                    '<td class="motion-select" id="'+c[v][]+'">'+ c[v]['案由']+'</td>'+
                    '<td>'+ c[v]['性质类别']+'</td>'+
