...
<div class="m-home clearfix">
    ...
    <div class="home-r">
        <div class="home-title"><p><span>人大议案待办：</span>&nbsp&nbsp&nbsp&nbsp<span>主办共<?php echo $mainCount1?>件；</span>&nbsp<span>协办共<?php echo $count1?>件 （点击左侧栏显示全部）</span></p></div>
        ...
        <?php endif ?>
        <div class="home-title"><p><span>政协提案待办：</span>&nbsp&nbsp&nbsp&nbsp<span>主办共<?php echo $mainCount2?>件；</span>&nbsp<span>协办共<?php echo $count2?>件 （点击左侧栏显示全部）</span></p></div>
