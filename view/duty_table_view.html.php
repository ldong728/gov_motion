<table id="" width="100%" border="0" cellpadding="0" cellspacing="0" class="">
    ...
    <tr id="row<?php echo $row['duty_id']?>">
        ...
        <td><button class="modify-btn" id="mod<?php echo $row['duty_id']?>">修改</button><button class="activity-btn" id="act<?php echo $row['duty_id']?>" data-activity="<?php echo $row['activity']?>"><?php echo 1==$row['activity']?'禁用':'启用'?></button></td>
