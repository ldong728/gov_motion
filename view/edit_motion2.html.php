        ...
        <div class="sug-main-content edit-area">
            ...
            <div class="table-list ">
                <table width="100%" height="296" border="0" bordercolor="#f08300" cellpadding="0" cellspacing="0" >
                    ...
                    <tr>
                        <th><p> 会议名称</p></th>
                        <td colspan="2" width="165"><p><?php echo substr($meetingInf['meeting_name'],0) ?></p>
                        </td>
                        <th>登记时间</th>
                        <td colspan="2" width="165"><span class="encoded-data"><?php echo json_encode($motion['登记时间'],JSON_UNESCAPED_UNICODE)?></span></td>
                        <th>状态</th>
                        <td colspan="2" width="165"> <span class="encoded-data"><?php echo json_encode($motion['状态'],JSON_UNESCAPED_UNICODE)?></span></td>
                    </tr>
                    <tr>
                        <th>案别</th>
                    ...
                    <tr>
                        <th>性质类别</th>
                        <td colspan="2"><span class="encoded-data"><?php echo json_encode($motion['性质类别'.$meetingInf['category']],JSON_UNESCAPED_UNICODE)?></span></td>
                        <th>性质</th>
