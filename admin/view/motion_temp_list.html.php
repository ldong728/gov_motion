        ...
        <div class="main">
            <table class="table sheet">
                ...
                <?php foreach($list as $row):?>
                    <tr>
                        <td class="ipt-toggle" id="<?php echo $row['motion_template_id'] ?>" data-col="motion_template_name" data-tbl="motion_template" data-index="motion_template_id"><?php echo $row['motion_template_name']?></td>
